...
trueprednoise=0.0			# noise of prediction with "truepred" (known optimum disturbed with noise that is normally distributed with standarddeviation "trueprednoise") 												
