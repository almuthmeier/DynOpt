...
# Parameters
#------------------------------------------------------------------------------
pathaddition="firsttest"	# "stepevaluation"

# benchmark problem
algorithm="dynea" 			# dynea or dynpso
repetitions=5				# number runs for each experiment
chgperiodrepetitions=10		# number runs for each change period
...
benchmarkfunctionfolderpath="/home/almuth/Documents/Promotion/Ausgaben/Robustness/data_2018-12-11/" # parent directory path of the benchmark functions
...
dims=2,10					# dimensionality of fitness function; comma-separated integers
...
addnoisytraindata="True"	# True if more training data are generated by adding noise to existing data
...
noises=0.05					# noise, required only for mpb-benchmarks; comma-separated floats
# ==================================================================================================================================================
# ==================================================================================================================================================
# ==================================================================================================================================================
...
#------------------------------------------------------------------------------
# Command 3
predictor=autoregressive				# no, rnn, autoregressive, tfrnn, tftlrnn, tftlrnndense

# static
outputdirectory="$pathaddition/steps""_""$timesteps/$algorithm""_""$predictor/" 									# name of the output directory. Necessary to separate results for different algorithm settings.				
outputdirectorypath="/home/almuth/Documents/Promotion/Ausgaben/Robustness/output_2018-12-11/$benchmarkfunction/"	# path to output folder
#------------------------------------------------------------------------------
