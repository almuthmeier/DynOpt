...
timesteps=2				# number of previous optima used prediction of the next step
...
outputdirectory="scriptout/$algorithm""_""$predictor""$algnameaddition/" # name of the output directory. Necessary to separate results
