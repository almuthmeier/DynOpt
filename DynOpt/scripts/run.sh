...
chgperiodrepetitions=3		# number runs for each change period
...
ubound=100					# maximum bound of the benchmark's range							   																				 # of this project 
...
timesteps=50				# number of previous optima used prediction of the next step
