...
benchmarkfunctionfolderpath="/raid/almuth/DynCMA/Ausgaben/data_2019-09-21_rangeDSB/vel-100.0/"		 	# parent directory path of the benchmark functions
		   																				 	# and child directory of the datasets folder of this project
#benchmarkfunctionfolderpath="/home/almuth/Documents/Promotion/Ausgaben/DynCMA/data_2019-09-21_rangeDSB/vel-2.0/" 
...
# CMA-ES
cmavariant=$4 # variant how CMA-ES includes prediction or path estimation for dynamic: "static" "resetcma" "predcma_internal" "predcma_external"
...
outputdirectorypath="/raid/almuth/DynCMA/Ausgaben/output_2019-09-26_truepred-dc_vel-100.0/$benchmarkfunction/"		# path to output folder
