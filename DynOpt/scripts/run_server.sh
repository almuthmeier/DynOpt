...
benchmarkfunctionfolderpath="/raid/almuth/DynCMA/Ausgaben/data_2019-09-21_rangeDSB/vel-2.0/"		 	# parent directory path of the benchmark functions
...
outputdirectorypath="/raid/almuth/DynCMA/Ausgaben/output_2019-09-26_truepred-dc_vel-1.0/$benchmarkfunction/"		# path to output folder
