...
benchmarkfunctionfolderpath="/raid/almuth/DynCMA/Ausgaben/data_2019-09-21_rangeDSB/vel-10.0/"		 	# parent directory path of the benchmark functions
		   																				 	# and child directory of the datasets folder of this project
#benchmarkfunctionfolderpath="/home/almuth/Documents/Promotion/Ausgaben/DynCMA/data_2019-09-21_rangeDSB/vel-10.0/" 
...
reinitializationmode="pred-UNC" # mode for re-initialization of the population: "no-RND" "no-VAR" "no-PRE" "pred-RND" "pred-UNC" "pred-DEV" "pred-KAL"
sigmafactors=0.01,0.1,1.0,10.0 # list of floats, factors for the sigma environment for random population re-initialization

# CMA-ES
cmavariant=$4 # variant how CMA-ES includes prediction or path estimation for dynamic: "resetcma" "predcma_internal" "predcma_external"
predvariant=$5				# variant how to calculate sig/m after a change: "simplest", "a", "b", "c", "d", "g" ,"branke", "f", "ha", "hb", "hd", "hawom", "hbwom", "hdwom"
...
outputdirectorypath="/raid/almuth/DynCMA/Ausgaben/output_2019-09-23_sigpred/$benchmarkfunction/"		# path to output folder
#outputdirectorypath="/home/almuth/Documents/Promotion/Ausgaben/DynCMA/output_2019-09-23_sigpred_hdwom5/$benchmarkfunction/"
#------------------------------------------------------------------------------
